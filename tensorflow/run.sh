...
mv tensorflow-1.14.0-cp34-none-linux_armv7l.whl tensorflow-1.14.0-cp37-none-linux_armv7l.whl

if ! pip3 install --user --no-cache-dir --prefix= --no-dependencies tensorflow-1.14.0-cp37-none-linux_armv7l.whl; then
